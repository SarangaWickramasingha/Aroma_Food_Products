function ProductImg({ image, alt = "", badge = "100% Pure Ceylon" }) {
  return (
    <div className="relative flex items-center justify-center py-6">
      ...
      <div className="absolute inset-0 -z-10 rounded-full bg-gradient-to-tr from-[#C44A3A]/25 via-[#E28834]/20 to-transparent blur-3xl transform scale-90 animate-pulse-subtle" />
      ...
      {badge && (
        <div className="absolute -top-1 -right-2 sm:top-2 sm:right-2 z-10 rounded-full border border-white/40 bg-white/80 px-3.5 py-1.5 shadow-lg backdrop-blur-md transition-transform duration-300 hover:scale-105">
          <span className="flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-wider text-[#2C1A0E]">
